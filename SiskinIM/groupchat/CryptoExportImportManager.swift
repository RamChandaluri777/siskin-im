...
class CryptoExportImportManager: NSObject {
     ...
     */
    func exportPublicKeyToDER(_ rawPublicKeyBytes: Data, keyType: String, keySize: Int,privatekey:Bool) -> Data? {
        if keyType == kSecAttrKeyTypeEC as String {
            return exportECPublicKeyToDER(rawPublicKeyBytes, keyType: keyType, keySize: keySize,privatekey:privatekey)
     ...
     */
    func exportPublicKeyToPEM(_ rawPublicKeyBytes: Data, keyType: String, keySize: Int,privatekey:Bool) -> String? {
        if keyType == kSecAttrKeyTypeEC as String {
            return exportECPublicKeyToPEM(rawPublicKeyBytes, keyType: keyType, keySize: keySize, privatekey: privatekey)
        } else if keyType == kSecAttrKeyTypeRSA as String {
    ...
    func exportRSAPublicKeyToPEM(_ rawPublicKeyBytes: Data, keyType: String, keySize: Int) -> String {
        return PEMKeyFromDERKey(exportRSAPublicKeyToDER(rawPublicKeyBytes, keyType: keyType, keySize: keySize), privatekey: false)
    }
     ...
     * Returns a DER representation of the key.
     */
    func exportECPublicKeyToDER(_ rawPublicKeyBytes: Data, keyType: String, keySize: Int,privatekey:Bool) -> Data {
     ...
     * Returns a DER representation of the key.
     */
    func exportECPublicKeyToPEM(_ rawPublicKeyBytes: Data, keyType: String, keySize: Int,privatekey:Bool) -> String {
        return PEMKeyFromDERKey(exportECPublicKeyToDER(rawPublicKeyBytes, keyType: keyType, keySize: keySize, privatekey: privatekey), privatekey: privatekey)
    }
     ...
     */
    func PEMKeyFromDERKey(_ data: Data,privatekey:Bool) -> String {
