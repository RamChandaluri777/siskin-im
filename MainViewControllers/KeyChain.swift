...
@objc open class KeychainService: NSObject {
    
    class func updateNonceSalt(service: String, account:String, data: String) {
    ...
    func removeNonceSalt(service: String, account:String) {
     ...
     func saveNonceSalt(service: String, account:String, data: String) {
